 ...
 * Title: RSAUtil.java
 * Description: RSA算法
 * Copyright (c) 个人版权所有 2019/7/5
 * Created DateTime: 2019/7/5 14:05
...
public class RSAUtil {
    ...
    public static String encrypt(String plainText, String puclic_key) {
        return encryptOfPublicKey(puclic_key, plainText);
    }
     ...
     * @return
     */
    public static String encryptOfPrivateKey(String privateKey, String plainText) {
        try {
            return encrypt(getPrivateKey(privateKey), plainText);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static String encryptOfPublicKey(String publicKey, String plainText) {
        try {
    ...
    public static String decrypt(String plainText, String private_key) {
        return decryptOfPrivateKey(private_key, plainText);
    }
     ...
     * @return
     */
    public static String decryptOfPublicKey(String publicKey, String enStr) {
        try {
            return decrypt(getPublicKey(publicKey), enStr);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static String decryptOfPrivateKey(String privateKey, String enStr) {
        try {
     ...
     * @param algorithm 算法名称：不填为默认SHA1withRSA 。
     * @return 签名值
     * 格式为：SHA1withDSA， MD2withRSA、MD5withRSA 或 SHA1withRSA等
     */
