...
import com.utry.baselib.baseui.BaseViewHolder;

import java.util.ArrayList;
import java.util.List;

/**
 * Title: HorizontalGridView.java
 * Description:横向滑动列表view
 * Copyright (c) 小远机器人版权所有 2021
 * Created DateTime: 2021/9/1 14:06
 * Created by xueli.
 */
public class HorizontalGridView extends LinearLayout {
    ...
    private class ChildAdapter extends RecyclerView.Adapter<BaseViewHolder> {
        private List mData;
    ...
    public static abstract class Adapter<T> {
        ...
        /**
         * 此方法应更新{@link BaseViewHolder＃itemView}的内容，以将项目反映在给定的位置
         *
         ...
         */
        public abstract void onBindViewHolder(@NonNull BaseViewHolder holder, @NonNull T dto, int currentPosition, int realPosition);
